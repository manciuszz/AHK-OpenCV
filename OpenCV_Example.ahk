...
Example() {	
	static scale := 0.3
	static window := "AHK | OpenCV - Preview Window"
	static file := "Images\2.png"
	static haarCascadePath := "haarcascades_GPU\haarcascade_fullbody.xml"
	...
	cv.ShowImage(window, pImg) ; Display input image inside window
